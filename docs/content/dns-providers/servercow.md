...
Configuration for the [Servercow](https://servercow.de/) DNS provider.

See the [lego documentation](https://go-acme.github.io/lego/dns/servercow/) for full details.

```yaml
letsEncrypt:
  dnsProvider: "servercow"
  dnsCredentials:
