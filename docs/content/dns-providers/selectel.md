...
Configuration for the [Selectel](https://kb.selectel.com/) DNS provider.

See the [lego documentation](https://go-acme.github.io/lego/dns/selectel/) for full details.

```yaml
letsEncrypt:
  dnsProvider: "selectel"
  dnsCredentials:
