...
Configuration for the [Katapult](https://katapult.io/) DNS provider.

See the [lego documentation](https://go-acme.github.io/lego/dns/katapult/) for full details.

```yaml
letsEncrypt:
  dnsProvider: "katapult"
  dnsCredentials:
