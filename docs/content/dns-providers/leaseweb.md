...
Configuration for the [Leaseweb](https://www.leaseweb.com/en/) DNS provider.

See the [lego documentation](https://go-acme.github.io/lego/dns/leaseweb/) for full details.

```yaml
letsEncrypt:
  dnsProvider: "leaseweb"
  dnsCredentials:
