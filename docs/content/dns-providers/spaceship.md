...
Configuration for the [Spaceship](https://www.spaceship.com/) DNS provider.

See the [lego documentation](https://go-acme.github.io/lego/dns/spaceship/) for full details.
