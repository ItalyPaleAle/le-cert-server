---
title: "Poweradmin"
nav_title: "Poweradmin"
---

<!-- Code generated by gen-dns-providers; DO NOT EDIT. -->

Configuration for the [Poweradmin](https://www.poweradmin.org/) DNS provider.

See the [lego documentation](https://go-acme.github.io/lego/dns/poweradmin/) for full details.

```yaml
letsEncrypt:
  dnsProvider: "poweradmin"
  dnsCredentials:
