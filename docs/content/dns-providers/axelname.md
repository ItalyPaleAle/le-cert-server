...
Configuration for the [Axelname](https://axelname.ru) DNS provider.

See the [lego documentation](https://go-acme.github.io/lego/dns/axelname/) for full details.

```yaml
letsEncrypt:
  dnsProvider: "axelname"
  dnsCredentials:
